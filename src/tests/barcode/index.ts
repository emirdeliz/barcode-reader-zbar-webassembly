...
export const barcodeInsurance = '836200000005865801620002001010202172425049125098';

export const barcodeDeposit = '23793381286006800396512000063300187440000002001';

export const barcodeInsuranceWithDigit = '838600000050096000190009000801782309000343062712';

export const barcodeInsuranceWithoutDigit = '85660000001015100247200024759192000220021353';

export const barcodeInsuranceWithoutDigit2 = '85860000001212203852135407162135096839813294';

export const barcodeInsuranceWithoutDigit3 = '85820000000572503282035607082021053959190446';

export const barcodeInsuranceWithoutDigit4 = '83630000000861701620000010102021767028153602';

export const barcodeInsuranceWithoutDigit5 = '83610000000460001920000038390570000082858680';

const getBilletFile = (fileName: string) => {
  const filePath = new URL(`file://${path.resolve(__dirname, '/__mock__', fileName)}`).href;
  return filePath;
};
